            ...
            <div class="accordion" id="filtersAccordion">
                ...
                <div class="accordion-item">
                    ...
                    <div style="margin-left: 50px;">
                        <input class="ml-3 mb-2 col-9" style="height: 25px; border-radius: 10px; font-size: 15px;"
                            type="search" value="Samsung">
                    </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingPantalla">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapsePantalla" aria-expanded="false" aria-controls="collapsePantalla">
                            Tamaño de pantalla
                        </button>
                    </h2>
