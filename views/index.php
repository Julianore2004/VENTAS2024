  ...
  <div id="carouselExampleAutoplaying" class="carousel slide mt-2" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <img src="./views/plantilla/img/carrucel/c1.jpeg" class="d-block w-100" alt="...">
      </a>
      </div>
      <div class="carousel-item">
        <a href="html/celulareshonor.html">
        <img src="./views/plantilla/img/carrucel/c2.jpeg" class="d-block w-100" alt="...">
      </a>
      </div>
      <div class="carousel-item">
        <a href="html/celularesappple.html">
        <img src="./views/plantilla/img/carrucel/c3.jpeg" class="d-block w-100" alt="...">
      </a>
      </div>
    </div>
      ...
      <div class="col-md-4">
        <div class="img3">
          <a  href="<?php echo BASE_URL ?>ofertas" >
            <img style="border-radius: 0%;" src="./views/plantilla/img/ofertas.png" class="card-img-top" alt="Ofertas">
          </a>
          <div class="cardindex-body">
            <a href="<?php echo BASE_URL ?>ofertas" style="text-decoration: none;" class="card-title">Ofertas</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="img3">
          <a  href="<?php echo BASE_URL ?>novedades">
            <img style="border-radius: 0%;" src="./views/plantilla/img/novedades.png" class="card-img-top" alt="Novedades">
          </a>
          <div class="cardindex-body">
            <a href="<?php echo BASE_URL ?>novedades" style="text-decoration: none;" class="card-title">Novedades</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="img3">
          <a href="<?php echo BASE_URL ?>accesorios">
            <img style="border-radius: 0%;" src="./views/plantilla/img/acc.png" class="card-img-top" alt="Accesorios">
          </a>
          <div class="cardindex-body">
            <a href="<?php echo BASE_URL ?>accesorios" style="text-decoration: none;" class="card-title">Accesorios</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-4" style="display: flex;">
      <div class="rowindex mt-4" style="justify-content: space-around; display: flex; gap: 10px; margin-top: 20px; margin-bottom: 20px;">
        ...
        <div class="col-3" style="width: 15rem;">
          ...
          <div class="cardindex-body">
            <a href="html/celularesxiaomi.html" style="text-decoration: none;" class="card-text">Xiaomi</a>
          </div>
        </div>
      </div>
      <div class="rowindex mt-4" style="justify-content: space-around; display: flex; gap: 10px; margin-top: 20px; margin-bottom: 20px;">
